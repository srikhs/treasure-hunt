...
<div id="main-container">
  ...
  <section id="home">
 <center> <img src="bg1.png" height="25%" width="25%"></center>
	...
	<form name="form1" method="post" action="aswers.php">
		  <center><label for="answer"><input type="hidden" name="question" id="question" value="1">Answer: </label><input name="answer" type="text" id="answer" height=25 width = 400>
                  </center></form>
