...
<div id="main-container">
  ...
  <div id="social-holder" class="hide-for-small">
		...
		<ul>
			...
			<li><a href="logout.php"><i class="icon-hand-right"></i><br>Log Out</a><div class="menu-title text-white text-center">Log Out</div></li>
...
3.If you are brooding about hacking your way to the top,shed that idea. Because, being blacklisted is not certainly what you would love to see.<br>
<br>
4.Answers can be typed as numbers and letters, which means, the answer can be '7crossstreet', not preferably 'sevencrossstreet'.<br><br>

5.While typing your answer, remember that, we spare you the pain of hitting space bar and capslock. NO SPACES AND CAPS!<br><br>

6. Making the right choices is not always that easy. So you are at your own right to beg and plead for clues on our facebook page. Bringing a smile on your face is all we want, but not always!
<br><br>
7.Revealing the answer to others on our facebook page is certainly not a great idea. By doing that, you are eliminating yourself from the hunt! BLACKLISTED! 
<br><br>
8. The only way forward is unlocking your way up! So what are you waiting for?? Happy sherlocking!
<br><br>
9.The winner of the contest will be the one who cracks the ultimate level at first.<br><br></h5>
				<div class="grey-hr"></div>
			</div>
