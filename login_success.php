...
<div id="main-container">
  ...
  <section id="home"><br>
   <center> <h7>Welcome <?php
$mydname = $_SESSION['dname'];
       ...
       <br>
    <center>
  	  <img src="header1.png" height="30%" width="30%"><br>
	
	    
	      </center>
                         <center> 
						 <img src="bg.png" height="50%" width="50%">
						 <br><br>
						 <br>
                         <a href="director.php"><img src="gohunt.jpg" width="20%" height="20%" class="liquid-nav-right-arrow"></a>&nbsp;&nbsp;&nbsp;&nbsp;
							<br><br><br><br>
					
						<img src="bottomlogo.png" height="40%" width="40%">
