...
<div id="main-container">
  ...
  <section id="home">
       ...
       <br>
    <center>
  	  <img src="header.png" height="30%" width="30%"><br>
						 ...
						 <br><br>
						 <br>
						 	<a href="main_login.php"><img src="login-b.jpg" height="20%" width="20%"></a>&nbsp;&nbsp;&nbsp;&nbsp;
								<a href="register.php"><img src="register.jpg" height="20%" width="20%"></a><br><br><br><br>
